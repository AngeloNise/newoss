...
<body>
    <header style="text-align: center;">
        <img src="https://drive.google.com/uc?export=view&id=1lHBxSUKfIsVo3dgXt-vXAxyE8IW2pu0Y" alt="PUP Logo" style="width: 100px; height: auto;">
        <h4>Republic of the Philippines</h4>
        <h4>POLYTECHNIC UNIVERSITY OF THE PHILIPPINES</h4>
        <h4>OFFICE OF THE VICE PRESIDENT FOR FINANCE</h4>
    </header>    
    <div class="fra-container">
        ...
        <div class="items_info"> 
            ...
            <p style="font-family: 'Calibri', sans-serif; font-size: 11px; font-weight: bold;">
                <strong>3. Total Estimated Proceeds (1e-2a)</strong> <?php echo e($annexa->total_estimated_proceeds ?? 'N/A'); ?>
    ...
    <footer>
        <p>Room 208 Charlie Del Rosario Building PUP A. Mabini Campus, Anonas Street, Sta. Mesa, Manila</p>
        <p>Trunk Line: 5335-1777 local 352; Website: www.pup.edu.ph e-mail: studentservices@pup.edu.ph</p>
        <p>"THE COUNTRY’S 1st POLYTECHNIC U"</p>
    </footer>
</body>
</html>
<?php /**PATH D:\College\oss\resources\views/pdf/annexapdf.blade.php ENDPATH**/ ?>