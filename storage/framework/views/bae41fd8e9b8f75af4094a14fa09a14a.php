        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: -5px">
            <tr>
                <td style="width: 80px; vertical-align: middle;">
                    <?php if($logo && $logo->pup_logo && file_exists(public_path('images/' . $logo->pup_logo))): ?>
                        <img src="<?php echo e(public_path('images/' . $logo->pup_logo)); ?>" width="80px" alt="University Logo">
                    <?php else: ?>
                        <p>Image not found</p>
                    <?php endif; ?>
                </td>
...
<?php /**PATH D:\College\oss\resources\views/layout/pdflayout.blade.php ENDPATH**/ ?>