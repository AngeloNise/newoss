                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(trim(strtolower($application['proposed_activity'])) === 'off campus'): ?>
                            ...
                            <tr>
                                <td style="border: 1px solid black; padding: 5px;"><?php echo e($application['name_of_project']); ?></td>
                                <td style="border: 1px solid black; padding: 5px;"><?php echo e($application['name_of_organization']); ?></td>
                                <td style="border: 1px solid black; padding: 5px;"><?php echo e(\Carbon\Carbon::parse($application['start_date'])->format('F j, Y')); ?></td>
                                <td style="border: 1px solid black; padding: 5px;"><?php echo e(\Carbon\Carbon::parse($application['end_date'])->format('F j, Y')); ?></td>
                                <td style="border: 1px solid black; padding: 5px;"><?php echo e($application['college_branch']); ?></td>
                                <td style="border: 1px solid black; padding: 5px;"><?php echo e($application['total_estimated_income']); ?></td>
                                <td style="border: 1px solid black; padding: 5px;"><?php echo e($application['place_of_activity'] ?: 'N/A'); ?></td>
                                <td style="border: 1px solid black; padding: 5px;"><?php echo e($application['status']); ?></td>
                                <td style="border: 1px solid black; padding: 5px;"><?php echo e(\Carbon\Carbon::parse($application['created_at'])->format('F j, Y')); ?></td>
                            </tr>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php if(!$hasOffCampus): ?>
                        <tr>
                            <td colspan="9" class="no-applications">No Off-Campus Applications for this time period.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
            <?php else: ?>
                <p class="no-applications">No Off-Campus Applications for this time period.</p>
            <?php endif; ?>
        </div>
    </div>
</body>
</html><?php /**PATH D:\College\oss\resources\views/faculty/generatepdf/offcampusapplicationspdf.blade.php ENDPATH**/ ?>