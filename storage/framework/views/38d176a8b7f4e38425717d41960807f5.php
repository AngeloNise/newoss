...
<div class="annexes">
    ...
    <a href="<?php echo e(url('/Annex-A')); ?>" class="button">Fund Raising Activity</a>
    <a href="<?php echo e(url('/Annex-B')); ?>" class="button">In-Campus Activity</a>
    <a href="<?php echo e(url('/Annex-C')); ?>" class="button">Off-Campus Activity</a>
</div>
