...
<div class="fra-container">
    ...
    <?php echo csrf_field(); ?>
        <h2> SUMMARY LIST OF PARTICIPANTS (Annex-C) </h2>
        ...
        <div class="fra-group">
            ...
            <input type="text" id="dean_or_director" name="dean_or_director" class="form-control" placeholder="Personnel-in-charge" value="<?php echo e(old('dean_or_director')); ?>">
        </div>
...
<?php echo $__env->make('layout.orglayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\College\oss\resources\views//org/auth/sidebar/offcampus/annex-c.blade.php ENDPATH**/ ?>