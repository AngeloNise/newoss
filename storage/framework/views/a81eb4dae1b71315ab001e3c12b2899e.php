    ...
    <?php else: ?>
        <table class="table">
            ...
            <tbody>
                ...
                <tr onclick="window.location='<?php echo e(route('faculty.fra-evaluation.show', $application->id)); ?>'" style="cursor:pointer;">
...
<?php echo $__env->make('layout.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\College\oss\resources\views/faculty/auth/fra-evaluation.blade.php ENDPATH**/ ?>