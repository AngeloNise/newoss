...
<div class="history-container">
    ...
    <?php
        // Get the most recent application that is either Approved or Returned, not in Pending Approval
    ...
    <?php else: ?>
        <table class="table">
            ...
            <tbody>
                <tr onclick="window.location='<?php echo e(url('Fund-Raising-History/applications/'.$mostRecentApprovedOrReturned->id.'/comments')); ?>'" style="cursor: pointer;">
