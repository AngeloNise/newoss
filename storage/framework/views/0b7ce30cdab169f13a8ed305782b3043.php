            ...
            <div class="cardincampus_incampus">  <!-- Event card -->
                ...
                <div class="cardbodyincampus_incampus">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $event)): ?>
                        <a href="<?php echo e(route('events.edit', $event->id)); ?>" class="btnincampus-edit_incampus">Edit</a>
                    <?php endif; ?>
