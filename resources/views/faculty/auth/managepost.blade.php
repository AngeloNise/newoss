...
<div class="container_incampus">
    ...
    <!-- Search bar to find events by department or other criteria -->
    ...
    @can('create', App\Models\Event::class) <!-- Check if user can create an event -->
    <div class="create-button">
        <a href="{{ route('faculty.events.create') }}" class="btnincampus-primary_incampus">Create Event</a>
    </div>
    @endcan
        ...
        @foreach($events as $event)
            <div class="cardincampus_incampus">
                ...
                <div class="cardbodyincampus_incampus">
                    ...
                    <a href="{{ $event->href }}" class="btnlinkincampus_incampus text-danger">Event Link</a>

                    <!-- Only show edit/delete options if user is authorized -->
                    @can('update', $event)
                        <a href="{{ route('faculty.events.edit', $event->id) }}" class="btnincampus-edit_incampus">Edit</a>
                    @endcan
                    @can('delete', $event)
