...
<body>
    ...
    <div class="container">
        ...
        <div style="margin-top: -15px; font-family: 'Calibri', sans-serif;">
            ...
            <div class="count-section" style="font-size: 14px">
                <p><strong>Total Pending Application:</strong> <span class="count">{{ $counts['inCampus']['Pending Approval'] }}</span></p>
                <p><strong>Total Returned:</strong> <span class="count">{{ $counts['inCampus']['Returned'] }}</span></p>
                <p><strong>Total Approved:</strong> <span class="count">{{ $counts['inCampus']['Approved'] }}</span></p>
                <p><strong>Total Applications:</strong> <span class="count">{{ array_sum($counts['inCampus']) }}</span></p>
            </div>
                ...
                <tbody>
                    ...
                    @foreach($applicationsArray as $application)
                        @if(trim(strtolower($application['proposed_activity'])) === 'fund raising')
                            ...
                            <tr>
                                <td style="border: 1px solid black; padding: 5px; text-align: left;">{{ $application['name_of_project'] }}</td>
                                <td style="border: 1px solid black; padding: 5px; text-align: left;">{{ $application['name_of_organization'] }}</td>
                                <td style="border: 1px solid black; padding: 5px; text-align: left;">{{ $application['proposed_activity'] }}</td>
                                <td style="border: 1px solid black; padding: 5px; text-align: left;">{{ $application['start_date'] }}</td>
                                <td style="border: 1px solid black; padding: 5px; text-align: left;">{{ $application['end_date'] }}</td>
                                <td style="border: 1px solid black; padding: 5px; text-align: left;">{{ $application['college_branch'] }}</td>
                                <td style="border: 1px solid black; padding: 5px; text-align: left;">{{ $application['total_estimated_income'] }}</td>
                                <td style="border: 1px solid black; padding: 5px; text-align: left;">{{ $application['place_of_activity'] ?: 'N/A' }}</td>
                                <td style="border: 1px solid black; padding: 5px; text-align: left;">{{ $application['status'] }}</td>
                                <td style="border: 1px solid black; padding: 5px; text-align: left;">{{ $application['submission_date'] }}</td>
                            </tr>
                        @endif
                    @endforeach
                    @if (!$hasFundRaising)
        ...
        <div class="page">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px; margin-top: 39px">
                ...
                <tbody>
                    @php $hasInCampus = false; @endphp
                    @foreach($applicationsArray as $application)
                        @if(trim(strtolower($application['proposed_activity'])) === 'in campus')
                            @php $hasInCampus = true; @endphp
                            <tr>
                                <td style="border: 1px solid black; padding: 5px; text-align: left;">{{ $application['name_of_project'] }}</td>
                                <td style="border: 1px solid black; padding: 5px; text-align: left;">{{ $application['name_of_organization'] }}</td>
                                <td style="border: 1px solid black; padding: 5px; text-align: left;">{{ $application['proposed_activity'] }}</td>
        ...
        <div class="page">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px; margin-top: 39px">
                ...
                <tbody>
                    @php $hasOffCampus = false; @endphp
                    @foreach($applicationsArray as $application)
                        @if(trim(strtolower($application['proposed_activity'])) === 'off campus')
                            @php $hasOffCampus = true; @endphp
                            <tr>
                                <td style="border: 1px solid black; padding: 5px; text-align: left;">{{ $application['name_of_project'] }}</td>
                                <td style="border: 1px solid black; padding: 5px; text-align: left;">{{ $application['name_of_organization'] }}</td>
                                <td style="border: 1px solid black; padding: 5px; text-align: left;">{{ $application['proposed_activity'] }}</td>
