...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/faculty/notif.css') }}">
...
<body>
                                ...
                                <ul style="list-style: none; padding: 0; margin: 0;">
                                    @foreach ($notifications as $notification)
                                        <li style="border-bottom: 1px solid #ddd; padding: 5px 0; cursor: pointer;" 
                                            onclick="window.location='{{ route('faculty.fra-a-evaluation.show', $notification['id']) }}'">
    ...
    <div class="sb" style="top: 0; position: fixed;">
        ...
        <div class="link-container">
            ...
            <ul>
                <li><a href="{{ url('/faculty/Generate-Report') }}"><i class="bx bx-copy-alt"></i> Generate Report</a></li>
                <br>
                ...
                <br>
                <li><a href="{{ url('/faculty/Post-Report') }}"><i class="bx bx-file"></i> Post-Activity Report</a></li>
                <br>
...
<script>
    ...
    window.addEventListener('load', function () {
        ...
        const notifications = @json($notifications); // This is the notifications array passed from your controller
